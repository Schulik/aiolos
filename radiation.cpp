...
void c_Sim::update_tau_s_jb(int j, int b) {
    ...
    if(j==num_cells+1) {
        ...
        radial_optical_depth_twotemp_he(j,b) = 0.; //cell_optical_depth(j,b);
    }
    else {
        radial_optical_depth_twotemp(j,b)    = radial_optical_depth_twotemp(j+1,b)    + cell_optical_depth_twotemp(j,b);
        radial_optical_depth_twotemp_he(j,b) = radial_optical_depth_twotemp_he(j+1,b) + tmp_cell_depth_he;
    }
